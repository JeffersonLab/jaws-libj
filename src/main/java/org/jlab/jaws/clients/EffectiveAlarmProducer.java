...
public class EffectiveAlarmProducer extends JAWSProducer<String, EffectiveAlarm> {
     ...
     */
    public EffectiveAlarmProducer(Properties props) {
    ...
    private static Properties setDefaults(Properties overrides) {
        ...
        defaults.put(ProducerConfig.CLIENT_ID_CONFIG, "effective-alarm-producer" + Instant.now().toString() + "-" + Math.random());
     ...
     */
    public Future<RecordMetadata> send(String key, EffectiveAlarm value) {
