...
/**
 * A CategoryProducer provides default properties values for CLIENT_ID, TOPIC, KEY_DESERIALIZER, and VALUE_DESERIALIZER.
 * A default send method is also provided.
 */
public class CategoryProducer extends JAWSProducer<String, String> {
    /**
     * The Category topic name
     */
    public static final String TOPIC = "alarm-categories";

    /**
     * Create a new CategoryProducer with the provided property overrides.
     *
     * @param props The properties, which will override any defaults set by this class
     */
    public CategoryProducer(Properties props) {
