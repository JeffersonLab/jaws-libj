 ...
 */
public class ActivationProducer extends JAWSProducer<String, AlarmActivationUnion> {
    /**
     * The topic name
     */
    public static final String TOPIC = "alarm-activations";
     ...
     */
    public ActivationProducer(Properties props) {
    ...
    private static Properties setDefaults(Properties overrides) {
        ...
        defaults.put(ProducerConfig.CLIENT_ID_CONFIG, "activation-producer" + Instant.now().toString() + "-" + Math.random());
     ...
     */
    public Future<RecordMetadata> send(String key, AlarmActivationUnion value) {
